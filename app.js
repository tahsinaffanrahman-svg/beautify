...
// 1. Extended Real Skincare Product Database (50 Products)
const products = [
    {
        id: 1,
    ...
    },
    {
        ...
        price: 182.00,
        image: "assets/images/skinceuticals_c_e_ferulic.png",
        rating: 4.7,
        reviews: 8900,
        description: `A potent antioxidant serum combining 15% pure Vitamin C, 1% Vitamin E, and 0.5% Ferulic Acid to neutralize free radicals, brighten skin, and reduce signs of aging.`,
        activeIngredients: `L-Ascorbic Acid (15%), Alpha Tocopherol (1%), Ferulic Acid (0.5%), Hyaluronic Acid`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'acne'],
        badge: "Gold Standard",
        clinicalNote: `Gold-standard vitamin C serum. Ferulic acid doubles antioxidant protection. Store in cool, dark place.`,
        useInstructions: `Apply 4-5 drops to dry face, neck, and chest every morning after cleansing. Follow with moisturizer and SPF.`,
        safetyProfile: `Safe for most skin types. May cause tingling on sensitive skin. Use SPF daily as vitamin C increases sun sensitivity.`
    },
    {
        id: 12,
        name: "Neutrogena Hydro Boost Water Gel",
        price: 21.99,
        image: "assets/images/neutrogena_hydro_boost_water_gel.png",
        rating: 4.6,
        reviews: 15200,
        description: `An oil-free, non-comedogenic water gel moisturizer with hyaluronic acid that instantly plumps and hydrates dry skin while locking in moisture for 24 hours.`,
        activeIngredients: `Hyaluronic Acid, Glycerin, Dimethicone`,
        concern: "hydration",
        skinTypes: ['dry', 'oily', 'combination', 'acne'],
        badge: "Drugstore Hero",
        clinicalNote: `Excellent lightweight hydrator with triple-weight hyaluronic acid. Oil-free formula ideal for oily and combination skin.`,
        useInstructions: `Apply evenly to face morning and evening after serum. Can be used under makeup.`,
        safetyProfile: `Oil-free, non-comedogenic, dermatologist-tested. Safe for sensitive skin.`
    },
    {
        id: 13,
        name: "Tatcha The Dewy Skin Cream",
        price: 72.00,
        image: "assets/images/tatcha_the_dewy_skin_cream.png",
        rating: 4.5,
        reviews: 6200,
        description: `A rich, nourishing moisturizer with Japanese Purple Rice and Okinawa Algae to support the skin microbiome and deliver deep, lasting hydration with a dewy finish.`,
        activeIngredients: `Japanese Purple Rice, Okinawa Algae, Hyaluronic Acid, Squalane`,
        concern: "hydration",
        skinTypes: ['dry', 'sensitive'],
        badge: "Cult Classic",
        clinicalNote: `Microbiome-supporting formula with fermented ingredients. Ideal for dry and dehydrated skin types seeking a luminous glow.`,
        useInstructions: `Warm a pearl-sized amount between fingertips and press into skin morning and evening.`,
        safetyProfile: `Free of mineral oil, sulfates, parabens, phthalates. Safe for sensitive skin.`
    },
    {
        id: 14,
        name: "Sunday Riley Good Genes All-In-One Lactic Acid Treatment",
        price: 85.00,
        image: "assets/images/sunday_riley_good_genes.png",
        rating: 4.6,
        reviews: 7800,
        description: `A high-potency lactic acid treatment that exfoliates, brightens, and smooths skin texture. Infused with licorice and lemongrass to calm and illuminate.`,
        activeIngredients: `Lactic Acid (5%), Licorice Root Extract, Lemongrass Extract, Purslane`,
        concern: "blemish",
        skinTypes: ['dry', 'oily', 'combination'],
        badge: "Allure Award Winner",
        clinicalNote: `Lactic acid gently exfoliates while licorice root brightens. Suitable for most skin types, including some sensitivity.`,
        useInstructions: `Apply a thin layer to clean, dry skin. Leave on for 10-15 minutes, then rinse. Use 3-4 times weekly.`,
        safetyProfile: `Avoid with other acids or retinoids in same routine. Use SPF daily. Patch test recommended.`
    },
    {
        id: 15,
        name: "Drunk Elephant F-Balm Electrolyte Waterfacial",
        price: 52.00,
        image: "assets/images/drunk_elephant_fbalm.png",
        rating: 4.4,
        reviews: 3400,
        description: `A sleeping facial mask that replenishes moisture and supports the skin barrier with ceramides, electrolytes, and niacinamide while you sleep.`,
        activeIngredients: `Ceramides, Electrolytes, Niacinamide, Vitamin F`,
        concern: "barrier",
        skinTypes: ['dry', 'sensitive', 'combination'],
        badge: "Barrier Savior",
        clinicalNote: `Overnight barrier repair formula. Excellent for dehydrated and stressed skin. Non-comedogenic.`,
        useInstructions: `Apply generously to clean, dry face after water-based serums. Leave on overnight. Use 2-3 times weekly.`,
        safetyProfile: `Silicone-free, fragrance-free, essential oil-free. Safe for sensitive and compromised barriers.`
    },
    {
        id: 16,
        name: "Summer Fridays Jet Lag Mask",
        price: 48.00,
        image: "assets/images/summer_fridays_jet_lag_mask.png",
        rating: 4.5,
        reviews: 9200,
        description: `A multitasking hydrating mask formulated with Vitamin C, Niacinamide, and Squalane to revitalize tired, dull skin and restore a healthy glow.`,
        activeIngredients: `Vitamin C, Niacinamide, Squalane, Glycerin`,
        concern: "hydration",
        skinTypes: ['dry', 'oily', 'sensitive', 'combination', 'acne'],
        badge: "Travel Essential",
        clinicalNote: `Instant hydration boost with brightening niacinamide. Can be used as mask or overnight treatment.`,
        useInstructions: `Apply a generous layer to clean skin. Leave on for 10 minutes, then rinse or tissue off. Use as needed.`,
        safetyProfile: `Vegan, cruelty-free, paraben-free, sulfate-free. Safe for all skin types.`
    },
    {
        id: 17,
        name: "Shiseido Benefiance Wrinkle Smoothing Eye Cream",
        price: 67.00,
        image: "assets/images/shiseido_benefiance_eye_cream.png",
        rating: 4.6,
        reviews: 4500,
        description: `A luxurious eye cream that targets deep wrinkles, puffiness, and dark circles with retinol and super bio-hyaluronic acid for a smoother, brighter eye area.`,
        activeIngredients: `Retinol, Super Bio-Hyaluronic Acid, Mukurossi Extract`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Anti-Aging Powerhouse",
        clinicalNote: `Retinol-based eye treatment for advanced aging concerns. Patented wrinkle-smoothing technology.`,
        useInstructions: `Apply a pearl-sized amount around the eye area each morning and evening. Gently pat with ring finger.`,
        safetyProfile: `Ophthalmologist-tested. Safe for contact lens wearers. Avoid direct contact with eyes.`
    },
    {
        id: 18,
        name: "Ole Henriksen Banana Bright Eye Cream",
        price: 42.00,
        image: "assets/images/ole_henriksen_banana_eye_cream.png",
        rating: 4.4,
        reviews: 5800,
        description: `A vitamin-rich eye cream with banana powder, Vitamin C, and collagen to instantly brighten dark circles and hydrate the delicate eye area.`,
        activeIngredients: `Vitamin C, Collagen, Banana Powder, Hyaluronic Acid`,
        concern: "anti-aging",
        skinTypes: ['dry', 'oily', 'combination', 'sensitive'],
        badge: "Brightening Hero",
        clinicalNote: `Light-reflecting banana powder pigments instantly neutralize dark circles while vitamin C works long-term.`,
        useInstructions: `Dot a small amount under eyes and along brow bone. Gently pat to blend. Use morning and night.`,
        safetyProfile: `Oil-free, non-comedogenic. Safe for sensitive eyes. Ophthalmologist-tested.`
    },
    {
        id: 19,
        name: "Supergoop! Unseen Sunscreen SPF 40",
        price: 38.00,
        image: "assets/images/supergoop_unseen_sunscreen.png",
        rating: 4.7,
        reviews: 11200,
        description: `An invisible, weightless, scentless sunscreen that works as a primer. Provides broad-spectrum SPF 40 protection with a sheer, velvety finish that works for all skin tones.`,
        activeIngredients: `Avobenzone (3%), Homosalate (8%), Octisalate (5%), Octocrylene (5%)`,
        concern: "spf",
        skinTypes: ['oily', 'acne', 'combination', 'sensitive'],
        badge: "Invisible Shield",
        clinicalNote: `Oil-free formula doubles as makeup primer. Invisible finish works on all skin tones without white cast.`,
        useInstructions: `Apply generously to face and neck 15 minutes before sun exposure. Reapply every 2 hours.`,
        safetyProfile: `Oil-free, fragrance-free, non-comedogenic. Safe for acne-prone and sensitive skin.`
    },
    {
        id: 20,
        name: "Laneige Cream Skin Refiner",
        price: 38.00,
        image: "assets/images/laneige_cream_skin_refiner.png",
        rating: 4.5,
        reviews: 7400,
        description: `A hybrid toner-moisturizer that combines the refreshing feel of a toner with the nourishing properties of a cream. Formulated with White Leaf Tea Water and Squalane.`,
        activeIngredients: `White Leaf Tea Water, Squalane, Glycerin`,
        concern: "hydration",
        skinTypes: ['dry', 'sensitive', 'combination'],
        badge: "K-Beauty Icon",
        clinicalNote: `Innovative cream-toner hybrid. Builds moisture barrier with each layer. Excellent for dehydrated skin.`,
        useInstructions: `Pour a small amount into palms and press gently into face after cleansing. Follow with serum and moisturizer.`,
        safetyProfile: `Alcohol-free, oil-free, fragrance-free, paraben-free. Safe for all skin types.`
    },
    {
        id: 21,
        name: "La Roche-Posay Cicaplast Baume B5",
        price: 17.99,
        image: "assets/images/laroche_cicaplast_baume.png",
        rating: 4.8,
        reviews: 21300,
        description: `A restorative, soothing multi-purpose balm with shea butter and madecassoside that calms irritated, compromised skin and supports skin barrier recovery.`,
        activeIngredients: `Madecassoside, Shea Butter, Panthenol, Zinc Gluconate`,
        concern: "barrier",
        skinTypes: ['sensitive', 'dry', 'acne'],
        badge: "Derm Favorite",
        clinicalNote: `Dermatologist-favorite barrier repair balm. Proven to soothe irritation, redness, and post-procedure skin. Non-comedogenic despite rich texture.`,
        useInstructions: `Apply a thin layer to affected or dry areas as needed. Can be used on face, lips, hands, and body.`,
        safetyProfile: `Alcohol-free, paraben-free, fragrance-free. Safe for sensitive and damaged skin.`
    },
    {
        id: 22,
        name: "The Inkey List Caffeine Eye Cream",
        price: 9.99,
        image: "assets/images/inkey_list_caffeine_eye_cream.png",
        rating: 4.3,
        reviews: 7200,
        description: `A lightweight, depuffing eye cream with caffeine and peptides that reduces dark circles, puffiness, and fine lines around the delicate eye area.`,
        activeIngredients: `Caffeine (5%), Peptides, Hyaluronic Acid, Matrixyl 3000`,
        concern: "anti-aging",
        skinTypes: ['dry', 'oily', 'combination', 'sensitive'],
        badge: "Budget MVP",
        clinicalNote: `High-concentration caffeine instantly constricts blood vessels to depuff. Peptides support collagen production long-term.`,
        useInstructions: `Dot a small amount under eyes each morning and evening. Gently pat with ring finger until absorbed.`,
        safetyProfile: `Alcohol-free, silicone-free, fragrance-free, cruelty-free. Safe for sensitive eyes.`
    },
    {
        id: 23,
        name: "The Ordinary Niacinamide 10% + Zinc 1%",
        price: 6.50,
        image: "assets/images/ordinary_niacinamide_zinc.png",
        rating: 4.5,
        reviews: 34500,
        description: `A high-concentration niacinamide serum that reduces sebum production, minimizes enlarged pores, and improves uneven skin tone. Zinc aids in blemish control.`,
        activeIngredients: `Niacinamide (10%), Zinc PCA (1%)`,
        concern: "blemish",
        skinTypes: ['oily', 'acne', 'combination'],
        badge: "Budget Hero",
        clinicalNote: `Exceptional value niacinamide serum. High concentration may cause sensitivity for some. Zinc helps control oil production.`,
        useInstructions: `Apply a few drops to face after cleansing and before heavier creams. AM and PM.`,
        safetyProfile: `Oil-free, alcohol-free, silicone-free. Patch test recommended due to high niacinamide concentration.`
    },
    {
        id: 24,
        name: "Rodan + Fields REDEFINE Anti-Aging Regimen",
        price: 195.00,
        image: "assets/images/rodan_fields_redefine.png",
        rating: 4.3,
        reviews: 2800,
        description: `A comprehensive 3-step anti-aging system with peptides and retinol that targets wrinkles, loss of firmness, and uneven texture for visibly younger-looking skin.`,
        activeIngredients: `Peptides, Retinol, Hyaluronic Acid, Ceramides`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Complete System",
        clinicalNote: `Multi-peptide complex with encapsulated retinol for reduced irritation. Clinical study shows significant wrinkle reduction in 12 weeks.`,
        useInstructions: `Use Step 1 (cleanser), Step 2 (serum), Step 3 (moisturizer) in order AM and PM.`,
        safetyProfile: `Contains retinol. Not for pregnant or nursing. Use SPF daily. May cause initial purging.`
    },
    {
        id: 25,
        name: "Dermalogica Daily Microfoliant",
        price: 67.00,
        image: "assets/images/dermalogica_microfoliant.png",
        rating: 4.6,
        reviews: 9200,
        description: `A rice-based enzyme powder that activates with water to gently exfoliate and brighten skin. Contains salicylic acid and papain to refine texture and minimize pores.`,
        activeIngredients: `Rice Enzymes, Salicylic Acid, Papain, Licorice Extract`,
        concern: "texture",
        skinTypes: ['dry', 'oily', 'combination', 'sensitive'],
        badge: "Daily Essential",
        clinicalNote: `Dual-action physical + enzymatic exfoliant. Gentle enough for daily use. Brightens and smooths with consistent use.`,
        useInstructions: `Pour half teaspoon into palms, add water, work into a lather. Massage onto face for 1 minute, rinse thoroughly.`,
        safetyProfile: `Sulfate-free, paraben-free. Safe for sensitive skin. Avoid contact with eyes.`
    },
    {
        id: 26,
        name: "Charlotte Tilbury Magic Cream",
        price: 105.00,
        image: "assets/images/charlotte_tilbury_magic_cream.png",
        rating: 4.5,
        reviews: 7800,
        description: `An iconic moisturizer enriched with peptides, hyaluronic acid, and vitamins C and E. Instantly hydrates, plumps, and illuminates while transforming skin texture.`,
        activeIngredients: `Peptides, Hyaluronic Acid, Vitamin C, Vitamin E, Rosehip Oil`,
        concern: "hydration",
        skinTypes: ['dry', 'combination'],
        badge: "Celebrity Favorite",
        clinicalNote: `Cult-favorite moisture cream with light-reflecting ingredients for instant radiance. Rich but absorbs well.`,
        useInstructions: `Apply a generous amount to face and neck each morning and evening. Can be applied before makeup.`,
        safetyProfile: `Contains fragrance. Not recommended for sensitive or reactive skin types.`
    },
    {
        id: 27,
        name: "Clarins Double Serum",
        price: 89.00,
        image: "assets/images/clarins_double_serum.png",
        rating: 4.6,
        reviews: 6500,
        description: `A dual-phase anti-aging serum combining 21 active plant extracts including turmeric and kiwi. The 2-in-1 formula boosts radiance, firmness, and hydration.`,
        activeIngredients: `Turmeric Extract, Kiwi Extract, Organic Harungana, Caffea Arabica`,
        concern: "anti-aging",
        skinTypes: ['dry', 'oily', 'combination'],
        badge: "Plant Power",
        clinicalNote: `Unique dual-chamber delivery system. Plant-based anti-aging with clinical results. Suitable for all skin types.`,
        useInstructions: `Apply 2-3 pumps to face and neck each morning and evening. Dispense from both chambers simultaneously.`,
        safetyProfile: `Paraben-free, phthalate-free. Safe for most skin types. Contains fragrance.`
    },
    {
        id: 28,
        name: "Estee Lauder Advanced Night Repair Serum",
        price: 125.00,
        image: "assets/images/estee_lauder_night_repair.png",
        rating: 4.7,
        reviews: 18900,
        description: `A synchronized recovery serum with Chronolux Power Signal Technology that supports skin's natural nighttime repair process and reduces multiple signs of aging.`,
        activeIngredients: `Chronolux Power Signal, Hyaluronic Acid, Pro-Vitamin D, Fermented Yeast Extract`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Iconic Serum",
        clinicalNote: `Best-selling serum globally with millions sold. Genomic science boosts skin's natural repair. Anti-aging benchmark.`,
        useInstructions: `Apply 2-3 drops to face and neck each evening after cleansing. Follow with moisturizer.`,
        safetyProfile: `Oil-free, dermatologist-tested. Suitable for most skin types.`
    },
    {
        id: 29,
        name: `Kiehl's Midnight Recovery Concentrate`,
        price: 55.00,
        image: "assets/images/kiehls_midnight_recovery.png",
        rating: 4.5,
        reviews: 5400,
        description: `An overnight face oil with squalane and evening primrose oil that replenishes skin while you sleep. Natural-origin ingredients restore radiance and smoothness.`,
        activeIngredients: `Squalane, Evening Primrose Oil, Lavender Essential Oil, Vitamin A`,
        concern: "hydration",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Nighttime Essential",
        clinicalNote: `Overnight oil concentrate that works with skin's natural repair cycle. Lightweight yet nourishing formula.`,
        useInstructions: `Apply 2-3 drops to fingertips and press into face and neck after evening moisturizer.`,
        safetyProfile: `Contains essential oils. Patch test if sensitive. Not recommended for severely oily or acne-prone skin.`
    },
    {
        id: 30,
        name: "Cosrx Advanced Snail 96 Mucin Power Essence",
        price: 22.00,
        image: "assets/images/cosrx_snail_mucin_essence.png",
        rating: 4.7,
        reviews: 28500,
        description: `A lightweight essence with 96% snail secretion filtrate that repairs damaged skin, improves hydration, and fades hyperpigmentation. A K-beauty cult favorite.`,
        activeIngredients: `Snail Secretion Filtrate (96%), Sodium Hyaluronate, Betaine`,
        concern: "barrier",
        skinTypes: ['dry', 'sensitive', 'oily', 'acne'],
        badge: "K-Beauty Cult",
        clinicalNote: `Snail mucin is rich in glycolic acid, hyaluronic acid, and glycoproteins. Excellent for acne scars and barrier repair.`,
        useInstructions: `Apply 2-3 drops to face after toner. Gently pat for absorption. Follow with moisturizer.`,
        safetyProfile: `Hypoallergenic, fragrance-free, alcohol-free. Safe for sensitive and acne-prone skin.`
    },
    {
        id: 31,
        name: "Tatcha The Water Cream",
        price: 72.00,
        image: "assets/images/tatcha_water_cream.png",
        rating: 4.5,
        reviews: 8700,
        description: `An oil-free, water-light moisturizer with Japanese wild rose and leopard lily that hydrates, smooths, and minimizes the look of pores without clogging them.`,
        activeIngredients: `Japanese Wild Rose, Leopard Lily, Hyaluronic Acid, Squalane`,
        concern: "texture",
        skinTypes: ['oily', 'combination', 'acne'],
        badge: "Oil-Free Wonder",
        clinicalNote: `Oil-free water cream delivers 72-hour hydration. Pore-minimizing Japanese botanicals give a soft-focus finish.`,
        useInstructions: `Apply a pearl-sized amount to face each morning and evening after serum.`,
        safetyProfile: `Oil-free, non-comedogenic, sulfate-free. Safe for oily and combination skin.`
    },
    {
        id: 32,
        name: "Farmacy Honey Halo Ceramide Moisturizer",
        price: 48.00,
        image: "assets/images/farmacy_honey_halo.png",
        rating: 4.6,
        reviews: 6200,
        description: `A ceramide-rich moisturizer with buckwheat honey and propolis that deeply hydrates and restores the skin barrier while locking in moisture for 24 hours.`,
        activeIngredients: `Ceramides, Buckwheat Honey, Propolis, Grape Seed Oil`,
        concern: "barrier",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Honey Glow",
        clinicalNote: `Triple-ceramide complex with antioxidant-rich honey. Barrier-supporting formula ideal for dry and compromised skin.`,
        useInstructions: `Apply generously to face and neck each morning and evening. A little goes a long way.`,
        safetyProfile: `Free of parabens, phthalates, sulfates, and synthetic fragrances. Cruelty-free.`
    },
    {
        id: 33,
        name: "Dr. Dennis Gross Skincare Alpha Beta Peel",
        price: 89.00,
        image: "assets/images/dr_dennis_gross_peel.png",
        rating: 4.5,
        reviews: 4800,
        description: `A two-step at-home peel with AHAs and BHAs that exfoliates, brightens, and smooths skin in just 2 minutes. Dermatologist-developed for visible results.`,
        activeIngredients: `Glycolic Acid, Lactic Acid, Salicylic Acid, Green Tea Extract`,
        concern: "texture",
        skinTypes: ['dry', 'oily', 'combination'],
        badge: "Derm Developed",
        clinicalNote: `Professional-grade at-home peel. Neutralized formula reduces irritation risk. Visible results in one use.`,
        useInstructions: `Step 1: Swipe over clean, dry face. Wait 2 minutes. Step 2: Swipe over same area. Do not rinse.`,
        safetyProfile: `Do not use with other acids or retinoids. Use SPF daily. Start with 2-3 times weekly.`
    },
    {
        id: 34,
        name: "Biossance Squalane + Vitamin C Rose Oil",
        price: 74.00,
        image: "assets/images/biossance_squalane_vitamin_c.png",
        rating: 4.4,
        reviews: 3600,
        description: `A lightweight, brightening face oil with squalane and vitamin C that firms, brightens, and evens skin tone. Rose scent creates a spa-like experience.`,
        activeIngredients: `Squalane, Vitamin C, Rosehip Oil, Raspberry Oil`,
        concern: "hydration",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Clean Beauty",
        clinicalNote: `100% plant-derived squalane base. Vitamin C derivative is stable and gentle. Brightens without irritation.`,
        useInstructions: `Apply 2-3 drops to face and neck after moisturizer. Press gently into skin. Use AM or PM.`,
        safetyProfile: `Vegan, cruelty-free, paraben-free, silicone-free. Safe for most skin types.`
    },
    {
        id: 35,
        name: "Glow Recipe Watermelon Glow Niacinamide Dew Drops",
        price: 35.00,
        image: "assets/images/glow_recipe_watermelon_dew.png",
        rating: 4.4,
        reviews: 10200,
        description: `A glow-boosting serum with niacinamide and watermelon extract that brightens, hydrates, and creates a dewy, glass-skin finish. Can be worn alone or under makeup.`,
        activeIngredients: `Niacinamide, Watermelon Extract, Hyaluronic Acid, PHA`,
        concern: "hydration",
        skinTypes: ['dry', 'oily', 'combination', 'sensitive'],
        badge: "Glass Skin",
        clinicalNote: `Liquid highlighter meets skincare. Niacinamide evens tone while PHA gently exfoliates.`,
        useInstructions: `Shake well. Apply a few drops to face after moisturizer. Can be layered under foundation for a dewy glow.`,
        safetyProfile: `Fragrance-free, alcohol-free, cruelty-free. Safe for all skin types.`
    },
    {
        id: 36,
        name: "Neutrogena Rapid Wrinkle Repair Retinol Cream",
        price: 24.99,
        image: "assets/images/neutrogena_rapid_wrinkle_repair.png",
        rating: 4.5,
        reviews: 18500,
        description: `An accelerated retinol moisturizer with stabilized retinol and hyaluronic acid that visibly reduces fine lines, wrinkles, and age spots in just one week.`,
        activeIngredients: `Retinol (Stabilized), Hyaluronic Acid, Vitamin C, Glucose Complex`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination'],
        badge: "Retinol Power",
        clinicalNote: `Accelerated retinol delivery system. Gentle enough for daily use. Clinically proven to reduce wrinkles in 1 week.`,
        useInstructions: `Apply a pea-sized amount to face and neck each evening after cleansing. Start with every other night.`,
        safetyProfile: `For external use only. Use SPF daily. Not for pregnant or nursing. May cause initial dryness.`
    },
    {
        id: 37,
        name: "Differin Adapalene Gel 0.1%",
        price: 15.99,
        image: "assets/images/differin_adapalene_gel.png",
        rating: 4.6,
        reviews: 31200,
        description: `A prescription-strength retinoid now available OTC. Treats and prevents acne by regulating cell turnover and reducing inflammation.`,
        activeIngredients: `Adapalene (0.1%), Carbomer, Propylene Glycol`,
        concern: "blemish",
        skinTypes: ['oily', 'acne', 'combination'],
        badge: "OTC Retinoid",
        clinicalNote: `FDA-approved OTC retinoid for acne. Adapalene is less irritating than tretinoin with comparable efficacy.`,
        useInstructions: `Apply a pea-sized amount to affected areas once daily after cleansing. Use consistently for 8-12 weeks for results.`,
        safetyProfile: `Start with 2-3 times weekly. Use SPF daily. Avoid other exfoliants. Dryness and purging are normal initially.`
    },
    {
        id: 38,
        name: "IT Cosmetics Confidence in a Cream",
        price: 58.00,
        image: "assets/images/it_cosmetics_confidence_cream.png",
        rating: 4.5,
        reviews: 7200,
        description: `A multi-tasking anti-aging moisturizer with peptides, retinol, and hyaluronic acid that targets wrinkles, loss of firmness, dehydration, and dullness all at once.`,
        activeIngredients: `Peptides, Retinol, Hyaluronic Acid, Collagen, Ceramides`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Total Face",
        clinicalNote: `Comprehensive anti-aging moisturizer with 5 key aging targets. Patented Total Face Technology.`,
        useInstructions: `Apply a generous amount to face and neck each morning and evening. Use alone or under makeup.`,
        safetyProfile: `Non-comedogenic. Sulfate-free, paraben-free. Safe for sensitive skin.`
    },
    {
        id: 39,
        name: "First Aid Beauty Ultra Repair Cream",
        price: 38.00,
        image: "assets/images/fab_ultra_repair_cream.png",
        rating: 4.7,
        reviews: 15200,
        description: `An intensive, rich moisturizer with colloidal oatmeal and shea butter that instantly relieves dry, distressed skin and provides 24-hour hydration.`,
        activeIngredients: `Colloidal Oatmeal, Shea Butter, Ceramides, Allantoin`,
        concern: "barrier",
        skinTypes: ['sensitive', 'dry', 'acne'],
        badge: "Sensitive Skin Hero",
        clinicalNote: `Dermatologist-developed for sensitive and eczema-prone skin. Colloidal oatmeal soothes while ceramides repair barrier.`,
        useInstructions: `Apply liberally to face and body as needed. Best used on damp skin after bathing.`,
        safetyProfile: `Fragrance-free, paraben-free, phthalate-free, gluten-free. Safe for sensitive and eczema-prone skin.`
    },
    {
        id: 40,
        name: "Mario Badescu Facial Spray with Aloe Cucumber and Green Tea",
        price: 12.00,
        image: "assets/images/mario_badescu_facial_spray.png",
        rating: 4.3,
        reviews: 25600,
        description: `A refreshing, calming facial mist that hydrates, soothes, and revitalizes skin throughout the day. The lightweight formula is perfect for makeup-setting and midday refreshment.`,
        activeIngredients: `Aloe Vera, Cucumber Extract, Green Tea Extract, Triethanolamine`,
        concern: "hydration",
        skinTypes: ['dry', 'oily', 'sensitive', 'combination', 'acne'],
        badge: "Mini Marvel",
        clinicalNote: `Hydrating mist with soothing botanicals. Helps calm redness and refresh without disturbing makeup.`,
        useInstructions: `Hold 6-8 inches from face, close eyes, and spray. Use after cleansing, before makeup, or throughout the day.`,
        safetyProfile: `Alcohol-free. Safe for all skin types. Avoid contact with eyes.`
    },
    {
        id: 41,
        name: "Laneige Lip Sleeping Mask",
        price: 24.00,
        image: "assets/images/laneige_lip_sleeping_mask.png",
        rating: 4.6,
        reviews: 21800,
        description: `An overnight lip mask with vitamin C and coconut oil that gently exfoliates and moisturizes to reveal smoother, softer, more supple lips by morning.`,
        activeIngredients: `Vitamin C, Coconut Oil, Shea Butter, Murumuru Butter`,
        concern: "hydration",
        skinTypes: ['dry', 'oily', 'sensitive', 'combination', 'acne'],
        badge: "Lip Savior",
        clinicalNote: `Berry complex and antioxidants nourish while you sleep. Light exfoliation from fruit enzymes reveals soft lips.`,
        useInstructions: `Apply a generous layer to lips before bed. Leave on overnight. Rinse or wipe off in the morning.`,
        safetyProfile: `For external use only. Avoid contact with eyes. Discontinue if irritation occurs.`
    },
    {
        id: 42,
        name: "Caolion Premium Hot and Cold Pore Pack",
        price: 36.00,
        image: "assets/images/caolion_pore_pack.png",
        rating: 4.3,
        reviews: 3400,
        description: `A two-step pore care system: Hot Pack opens pores and draws out impurities, Cold Pack tightens and refines pores. Deep pore cleansing in 15 minutes.`,
        activeIngredients: `Kaolin, Aloe Vera, Green Tea Extract, Menthol`,
        concern: "texture",
        skinTypes: ['oily', 'combination', 'acne'],
        badge: "Pore Expert",
        clinicalNote: `Thermal pore therapy. Hot pack increases circulation, cold pack minimizes pores. Instant visible results.`,
        useInstructions: `Step 1: Apply Hot Pack for 10-15 minutes, rinse with warm water. Step 2: Apply Cold Pack for 5-10 minutes, rinse with cool water.`,
        safetyProfile: `For external use only. Not for broken or irritated skin. Test temperature before applying.`
    },
    {
        id: 43,
        name: "Youth to the People Superfood Air-Whip Moisture Cream",
        price: 48.00,
        image: "assets/images/yttp_superfood_cream.png",
        rating: 4.5,
        reviews: 5400,
        description: `A lightweight, air-whipped moisturizer with antioxidant-rich kale, spinach, and green tea that hydrates and balances all skin types without heaviness.`,
        activeIngredients: `Kale Extract, Spinach Extract, Green Tea, Hyaluronic Acid`,
        concern: "hydration",
        skinTypes: ['dry', 'oily', 'combination', 'sensitive'],
        badge: "Superfood",
        clinicalNote: `Superfood antioxidant complex. Air-whipped texture absorbs instantly. Balanced hydration for all skin types.`,
        useInstructions: `Apply a dime-sized amount to face and neck each morning and evening after serum.`,
        safetyProfile: `Vegan, cruelty-free, paraben-free, phthalate-free, silicone-free. Safe for all skin types.`
    },
    {
        id: 44,
        name: "Dr. Barbara Sturm Hyaluronic Serum",
        price: 300.00,
        image: "assets/images/dr_barbara_sturm_hyaluronic.png",
        rating: 4.4,
        reviews: 1800,
        description: `A high-concentration hyaluronic acid serum with purslane and Portulaca that delivers intense hydration, plumps fine lines, and restores youthful bounce.`,
        activeIngredients: `Hyaluronic Acid (High/Low Molecular Weight), Purslane, Portulaca Extract`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'sensitive'],
        badge: "Luxury Hydration",
        clinicalNote: `Dual-weight hyaluronic acid penetrates at different skin levels. Purslane soothes inflammation. Celebrity-favorite luxury serum.`,
        useInstructions: `Apply 2-3 drops to damp skin after cleansing. Gently press. Follow with moisturizer.`,
        safetyProfile: `Fragrance-free, paraben-free, PEG-free. Suitable for sensitive and post-procedure skin.`
    },
    {
        id: 45,
        name: "Olay Regenerist Micro-Sculpting Cream",
        price: 28.99,
        image: "assets/images/olay_regenerist_micro_sculpting.png",
        rating: 4.6,
        reviews: 22300,
        description: `An amino-peptide moisturizer with hyaluronic acid and vitamin B3 that visibly plumps and lifts facial contours, reducing the appearance of deep wrinkles.`,
        activeIngredients: `Amino-Peptides, Hyaluronic Acid, Niacinamide (Vitamin B3), Shea Butter`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination'],
        badge: "Drugstore Powerhouse",
        clinicalNote: `Anti-aging moisturizer with proven amino-peptide complex. Often compared to luxury creams at fraction of price.`,
        useInstructions: `Apply to face and neck each morning and evening. Use gentle upward strokes to massage.`,
        safetyProfile: `Non-comedogenic, dermatologist-tested. Suitable for most skin types.`
    },
    {
        id: 46,
        name: "Eucerin Advanced Repair Cream",
        price: 13.99,
        image: "assets/images/eucerin_advanced_repair.png",
        rating: 4.5,
        reviews: 18900,
        description: `A rich, fragrance-free body and face cream with ceramides and natural moisturizing factors that relieves extremely dry, rough skin for 48 hours.`,
        activeIngredients: `Ceramides, Shea Butter, Glycerin, Urea`,
        concern: "barrier",
        skinTypes: ['sensitive', 'dry'],
        badge: "Dry Skin Savior",
        clinicalNote: `Dermatologist-recommended for dry skin. Contains urea for gentle exfoliation and deep moisturization.`,
        useInstructions: `Apply liberally to affected areas twice daily. For best results, apply to slightly damp skin.`,
        safetyProfile: `Fragrance-free, dye-free, paraben-free, non-comedogenic. Safe for eczema-prone and diabetic skin.`
    },
    {
        id: 47,
        name: "Vichy Mineral 89 Hyaluronic Acid Serum",
        price: 35.00,
        image: "assets/images/vichy_mineral_89.png",
        rating: 4.5,
        reviews: 8100,
        description: `A daily skin booster with 89% Vichy Mineralizing Water and hyaluronic acid that strengthens the skin barrier, hydrates deeply, and improves resistance to environmental stressors.`,
        activeIngredients: `Vichy Mineralizing Water (89%), Hyaluronic Acid, Glycerin`,
        concern: "barrier",
        skinTypes: ['dry', 'sensitive', 'combination'],
        badge: "Mineral Rich",
        clinicalNote: `Mineral-rich volcanic water from France strengthens barrier function. Simple 11-ingredient formula.`,
        useInstructions: `Apply 2-3 drops to face after cleansing. Follow with moisturizer. Use AM and PM.`,
        safetyProfile: `Fragrance-free, paraben-free, alcohol-free, dermatologist-tested. Safe for sensitive skin.`
    },
    {
        id: 48,
        name: "CeraVe Hydrating Facial Cleanser",
        price: 16.99,
        image: "assets/images/cerave_hydrating_cleanser.png",
        rating: 4.6,
        reviews: 35600,
        description: `A gentle, non-foaming cleanser with ceramides and hyaluronic acid that cleanses without stripping the skin barrier while maintaining the skin's natural moisture.`,
        activeIngredients: `Ceramides (1, 3, 6-II), Hyaluronic Acid, Glycerin, Niacinamide`,
        concern: "barrier",
        skinTypes: ['dry', 'sensitive', 'acne', 'combination'],
        badge: "Derm Standard",
        clinicalNote: `Dermatologist-developed with essential ceramides. MVE Technology delivers sustained ingredient release.`,
        useInstructions: `Apply to damp skin, massage gently, and rinse. Use morning and evening.`,
        safetyProfile: `Fragrance-free, non-comedogenic, non-drying. Safe for sensitive, eczema-prone, and acne-prone skin.`
    },
    {
        id: 49,
        name: "Shiseido Ultimune Power Infusing Concentrate",
        price: 79.00,
        image: "assets/images/shiseido_ultimune.png",
        rating: 4.5,
        reviews: 5200,
        description: `A skin immunity booster with ReNeura Technology and lotus extract that strengthens skin's natural defenses, improves radiance, and enhances absorption of subsequent skincare.`,
        activeIngredients: `ReNeura Technology, Lotus Extract, Reishi Mushroom, Glycerin`,
        concern: "anti-aging",
        skinTypes: ['dry', 'oily', 'combination', 'sensitive'],
        badge: "Immunity Boost",
        clinicalNote: `Skin immunity complex reduces visible signs of environmental damage. Enhances efficacy of products used after it.`,
        useInstructions: `Apply 2 pumps to face after cleansing and before serum. Use AM and PM.`,
        safetyProfile: `Alcohol-free, paraben-free, mineral oil-free. Suitable for all skin types.`
    },
    {
        id: 50,
        name: "Dior Capture Totale Le Serum",
        price: 165.00,
        image: "assets/images/dior_capture_totale.png",
        rating: 4.5,
        reviews: 3400,
        description: `A rejuvenating serum with long-lasting cellular renewal technology and wild pansy extract that visibly corrects all signs of aging for transformed skin.`,
        activeIngredients: `Long-Lasting Cellular Renewal Extract, Wild Pansy, Hyaluronic Acid, Vitamin C`,
        concern: "anti-aging",
        skinTypes: ['dry', 'combination', 'oily', 'sensitive'],
        badge: "Luxury Rejuvenation",
        clinicalNote: `Luxury anti-aging serum targeting all aging signs. Patented cellular renewal technology. Silky texture with immediate visible glow.`,
        useInstructions: `Apply 2-3 pumps to face and neck each morning and evening. Follow with moisturizer.`,
        safetyProfile: `Dermatologist-tested. Suitable for all skin types. For external use only.`
    },
];
